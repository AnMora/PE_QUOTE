import UpdateAdminComponent from "@/app/components/updateAdmin";
...
export default async function editAdminInformation({params}) {
  ...
  return (
    <>
      <h1 className="mt-4">Editar datos de Administrador</h1>
      ...
      {profile ? <UpdateAdminComponent admin={profile} /> : <p>Failed to fetch the data</p>}
    </>
  );
}
