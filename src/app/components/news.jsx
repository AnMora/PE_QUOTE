export default function NewsInformation(params) {
  return (
    <>
      <div className="card border-success mt-2 mb-2">
        ...
        <div className="card-body">
          <h3 className="text-warning">Actualizaciones 10/9/2025</h3>
          <p>
            1. Se implementan cambios en estilos y visuales del sitio para dar armonia y detalles mas esteticos
          </p>  
          <p>
            2. Se implementan cambios administrativos para poder manejar informacion de usuarios
          </p>
          <p>
            3. Se trabaja en implementaciones de costos insumos y registro de usuarios en sitio web
          </p>
          <h3 className="text-warning">Actualizaciones 9/7/2025</h3>
          <p>
          ...
          <h3 className="text-warning">Actualizaciones 1/6/2025</h3>
          <p>
          ...
          <h3 className="text-warning">Actualizaciones 20/5/2025</h3>
          <p>
